...
import { CheckCircle, Home, Package, ArrowLeft, Clock } from 'lucide-react-native'; // Imported Clock icon
...
    address,
    items = [],
    // ⭐ UPDATED: Destructure deliveryTime from route.params
    deliveryTime, 
  } = route.params || {};
...
          </View>
          {/* ⭐ ADDED: Display Estimated Delivery Time */}
          {deliveryTime && (
            <View style={[styles.detailRow, { borderTopWidth: 1, borderTopColor: COLORS.border, marginTop: 5, paddingTop: 8 }]}>
...
          </View>
          ...
          {/* ⭐ Conditional display based on whether a specific delivery time is available */}
          {deliveryTime ? (
              <View style={styles.nextStep}>
                <Clock size={20} color={COLORS.primary} />
                <Text style={styles.nextStepText}>
                    Your order is estimated to be delivered by **{deliveryTime}**
                </Text>
              </View>
          ) : (
              <View style={styles.nextStep}>
                <Package size={20} color={COLORS.primary} />
                <Text style={styles.nextStepText}>
                    Order will be delivered in your selected time slot: **{deliverySlot}**
                </Text>
              </View>
          )}
